					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<div class="post-meta-bottom">
							...
							<div class="post-nav group">
								...
								?>
								<a href="<?php echo esc_url( $prev_attachment_url ); ?>" class="post-nav-older" rel="attachment"><?php _e( '&laquo; Previous<span> attachment</span>', 'jayp' ); ?></a>
								<a href="<?php echo esc_url( $next_attachment_url ); ?>" class="post-nav-newer" rel="attachment"><?php _e( 'Next<span> attachment</span> &raquo;', 'jayp' ); ?></a>
